...
-- returns a table containing /etc/group and /etc/passwd.
-- ["login"/"uid"/uid][take a look at t below for the list]
-- [login].[groups/gids] is a list user is in (sequence)
-- [login].group.user -> t/f
